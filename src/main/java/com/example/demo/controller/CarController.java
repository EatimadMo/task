...
//    ArrayList<Car> cars = new ArrayList<>();
//    ArrayList<Color> colors = new ArrayList<>();
//    ArrayList<YearOfMake> yearOfMake = new ArrayList<>();
//    ArrayList<Price> price = new ArrayList<>();
//
//
//    @GetMapping
//    public ArrayList<Car> getCar(){return cars;}
//
//    @PostMapping
//    public ResponseEntity<String> addCar(@RequestBody Car car){
//
//        if (!checkInput(car)) {
//            return ResponseEntity.status(400).body("enter all the fields");
//        }
//        cars.add(car);
...
//    }
//    @PostMapping("/years")
//    public ResponseEntity yearsFunds(@RequestBody yearOfMake yearsOfMake){
//        for (int i = 0; i < cars.size(); i++) {
//            if(cars.get(i).getYearOfMake() == (yearsOfMake.getyearOfMake())) {
//                if(!(cars.get(i).getYearOfMake() == (yearsOfMake.getyearOfMake()))){
//                    return ResponseEntity.status(400).body("years doesn't match the user id");
